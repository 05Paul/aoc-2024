...
func (d *Day03) SolvePart1(content string) (fmt.Stringer, error) {
	parser := d.parser(func(captures []any) Operation[int] {
...
func (d *Day03) parser(combinator func(captures []any) Operation[int], captures ...SubCapture[any]) Capture[int] {
	return &Parser[int]{
		sub:          captures,
		currentIndex: 0,
		outputs:      make([]any, 0),
...
func (d *Day03) captureString(value string) SubCapture[any] {
...
func (d *Day03) captureBetween(from string, to string) SubCapture[any] {
...
func (d *Day03) captureInt(minDigits int, maxDigits int) SubCapture[any] {
	return &IntCapture{
		minDigits:  minDigits,
		maxDigits:  maxDigits,
		digitCount: 0,
